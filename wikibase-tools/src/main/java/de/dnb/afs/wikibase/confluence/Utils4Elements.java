...
//		}
		...
		if (tagName.equals("p")) {
			...
			Utils4Resources.addExample(props, wbEntityId, panelElement, propertyIdValue, config,
					entityLoader);
		} else if (tagName.equals("subproperty")) {
			StringValue value = Datamodel.makeStringValue(panelElement.attr("label"));
			props.addStatement(StatementBuilder.forSubjectAndProperty(wbEntityId, propertyIdValue)
