...
public class Utils4Resources {
	...
	private static final Log logger = LogFactory.getLog(Utils4Resources.class);
	...
	public static void addExample(List<Statement> statements, EntityIdValue wbEntityId, Element element,
	...
	public static void addPanelH3(List<Statement> statements, EntityIdValue wbEntityId, Element panelParagraph,
			PropertyIdValue propertyId, ConfluenceWbConfig config) {
...
//		}
		...
		if (tagName.equals("p")) {
			...
			addPanelH3(props.getStatements(), wbEntityId, panelElement, propertyIdValue, config);
			...
			addExample(props.getStatements(), wbEntityId, panelElement, propertyIdValue, config, entityLoader);
