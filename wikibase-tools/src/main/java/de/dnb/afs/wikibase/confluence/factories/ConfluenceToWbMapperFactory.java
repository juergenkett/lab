...
//		wbMappings.add(new WbMappingTextValue("Status.*", newPropertyId("P485"), config));
		...
		WbMapper4Elements ret = new WbMapper4Elements(wbEditor, new STAiDGeneratorImpl(config, wbEditor),
				wbMappings, config);
	...
	public static WbMapper4Resources newWbMapper4Ressources(
		...
		List<WbMapping> wbMappings = new ArrayList<WbMapping>();
		WbMapper4Resources ret = new WbMapper4Resources(wbEditor,
				new STAiDGeneratorImpl(config, wbEditor), wbMappings, config);
