...
public class WbMapping4RecordingMethod extends AbstractWbMapping {
	...
	public void doMap(String panelLabelDe, Elements paragraphs, WbEntityProperties entity)
		...
		for (Element paragraph : paragraphs) {
			...
			if (qualifier != null) {
				addKeyword(entity, entity.getEntityId(), paragraph, wbId, config, qualifier);
			} else {
	...
	public static void addKeyword(WbEntityProperties props, EntityIdValue wbEntityId, Element panelParagraph,
