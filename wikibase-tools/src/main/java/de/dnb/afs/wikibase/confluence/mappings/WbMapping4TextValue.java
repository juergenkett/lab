...
public class WbMapping4TextValue extends AbstractWbMapping {

	private static final Log logger = LogFactory.getLog(WbMapping4TextValue.class);
	
	public WbMapping4TextValue(String labelPattern, PropertyIdValue wbId, ConfluenceWbConfig config,
